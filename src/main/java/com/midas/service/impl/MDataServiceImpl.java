...
public class MDataServiceImpl extends DataBase implements DataService {

    private Logger logger = LoggerFactory.getLogger(MDataServiceImpl.class);
...
//                    "重复的数据：" + map.get("work_area") + ", " + map.get("construction_year"));
//        }
    ...
    public List<String> getFilepath(String volLabel,String dataSource) {
        ...
        for (Map<String, Object> map : list) {
            ...
            List<String> fileAll = getAllFilesByFolder( sourceWorkdir, ObjectUtils.toString(map.get("area_block_name")),1);
                    
//                    getAllFiles("",
//                    ObjectUtils.toString(map.get("tape_number")), 1);
