		...
		<form action="<%=basePath%>/data/insert.do">
			...
			<ul class="forminfo">
				<li style="display:inline;">
					<label>&nbsp;&nbsp;工&nbsp;区&nbsp;&nbsp;&nbsp;&nbsp;</label>
					<input name="work_area" type="text" class="dfinput" value="" />
				</li>
				&nbsp;&nbsp;&nbsp;
				<li style="display:inline;">
					<label>测线(束)号</label>
				...
				<li style="display:inline; margin-top: 10px">
					<label>起止序号</label>
					<input name="se_number" type="text" class="dfinput" value="" />
				</li>&nbsp;&nbsp;&nbsp;
				<li style="display:inline; margin-top: 10px">
					<label>&nbsp;记录长度&nbsp;&nbsp;</label>
				...
				<li style="display:inline; margin-top: 10px">
					<label>磁带盘数</label>
					<input name="tape_size" type="text" class="dfinput" value="" />
				</li>&nbsp;&nbsp;&nbsp;
				<li style="display:inline; margin-top: 10px">
					<label>数据量(GB)</label>
				...
				<li style="display:inline; margin-top: 10px">
					<label>施工年度</label>
					<input name="construction_year" type="text" class="dfinput" value="" />
				</li>&nbsp;&nbsp;&nbsp;
				<li style="display:inline; margin-top: 10px">
					<label>&nbsp;施工单位&nbsp;&nbsp;</label>
					<input name="construction_unit" type="text" class="dfinput" value="" />
				</li>
				<br /><br />
				<li>
					<label>备注</label>
